---
title: "Part 2: COVID-19 Loan Distributions (extended)"
...
We will also load my favorite non-academic graphing theme that I included in the "plot_themes" folder.
...
```{r, include = FALSE}
##### Save objects for results #####

### Graphs
saveRDS(grant.p2, './r_objects/p_lower_90_grant.rds') # histograms of lower 90%
saveRDS(loan.p1, './r_objects/p_lower_90_loan.rds')

saveRDS(grant.p4, './r_objects/p_upper_10_grant.rds') # histograms of upper 0.5%-10%
saveRDS(loan.p2, './r_objects/p_upper_10_loan.rds')

saveRDS(grant.p5, './r_objects/p_upper_05_grant.rds') # histograms of upper 0.5%
saveRDS(loan.p3, './r_objects/p_upper_05_loan.rds')

### Other
saveRDS(grant.perc.500k.1m, './r_objects/grant_500k_1m_perc.rds') # percent recipients of between 500k & 1m 
saveRDS(loan.perc.500k.1m, './r_objects/loan_500k_1m_perc.rds')

saveRDS(fohund.milplus, './r_objects/grant_400m_plus_comps.rds') # names of recipients of $400m or more
saveRDS(fohund.milplus2, './r_objects/loan_400m_plus_comps.rds')
```
